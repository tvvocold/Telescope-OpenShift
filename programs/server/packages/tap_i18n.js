...
var HTTP = Package['tap:http-methods'].HTTP;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
TAPi18next.init({resStore: {}, fallbackLng: globals.fallback_language});                                               // 1
                                                                                                                       // 2
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
_.extend(TAPi18n, {
  ...
  _getProjectLanguages: function() {
    if (this._enabled()) {
      if (_.isArray(this.conf.supported_languages)) {
        ...
        return _.keys(this.languages_available_for_project);
      }
    } else {
  ...
  getLanguages: function() {
    var desc, lang_tag, languages, _ref;
    if (!this._enabled()) {
      return null;
    }
    languages = {};
    _ref = this.languages_available_for_project;
    for (lang_tag in _ref) {
      desc = _ref[lang_tag];
      languages[lang_tag] = {
        name: desc[1],
        en: desc[0]
