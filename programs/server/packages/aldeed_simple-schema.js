...
SimpleSchema._makeGeneric = function(name) {                                                                           // 562
  if (typeof name !== "string") {                                                                                      // 563
    return null;                                                                                                       // 564
                                                                                                                       ...
                                                                                                                       // 566
  return name.replace(/\.[0-9]+\./g, '.$.').replace(/\.[0-9]+/g, '.$');                                                // 567
};                                                                                                                     // 568
                                                                                                                       // 569
...
SimpleSchema.prototype.condition = function(obj) {                                                                     // 579
  ...
  if (isModifier && isNotModifier) {                                                                                   // 592
    throw new Match.Error("Object cannot contain modifier operators alongside other keys");                            // 593
                                                                                                                       ...
                                                                                                                       // 595
  if (!self.newContext().validate(obj, {modifier: isModifier, filter: false, autoConvert: false})) {                   // 596
    throw new Match.Error("One or more properties do not match the schema.");                                          // 597
  }                                                                                                                    // 598
                                                                                                                       // 599
  return true;                                                                                                         // 600
};                                                                                                                     // 601
                                                                                                                       // 602
function logInvalidKeysForContext(context, name) {                                                                     // 603
  Meteor.startup(function() {                                                                                          // 604
    Deps.autorun(function() {                                                                                          // 605
      if (!context.isValid()) {                                                                                        // 606
        console.log('SimpleSchema invalid keys for "' + name + '" context:', context.invalidKeys());                   // 607
      }                                                                                                                // 608
    });                                                                                                                // 609
  });                                                                                                                  // 610
}                                                                                                                      // 611
                                                                                                                       // 612
SimpleSchema.prototype.namedContext = function(name) {                                                                 // 613
  var self = this;                                                                                                     // 614
  if (typeof name !== "string") {                                                                                      // 615
    name = "default";                                                                                                  // 616
  }                                                                                                                    // 617
  if (!self._validationContexts[name]) {                                                                               // 618
    self._validationContexts[name] = new SimpleSchemaValidationContext(self);                                          // 619
                                                                                                                       // 620
    // In debug mode, log all invalid key errors to the browser console                                                // 621
    if (SimpleSchema.debug && Meteor.isClient) {                                                                       // 622
      Deps.nonreactive(function() {                                                                                    // 623
        logInvalidKeysForContext(self._validationContexts[name], name);                                                // 624
      });                                                                                                              // 625
    }                                                                                                                  // 626
  }                                                                                                                    // 627
  return self._validationContexts[name];                                                                               // 628
};                                                                                                                     // 629
                                                                                                                       // 630
// Global custom validators                                                                                            // 631
SimpleSchema._validators = [];                                                                                         // 632
SimpleSchema.addValidator = function(func) {                                                                           // 633
  SimpleSchema._validators.push(func);                                                                                 // 634
};                                                                                                                     // 635
                                                                                                                       // 636
// Instance custom validators                                                                                          // 637
// validator is deprecated; use addValidator                                                                           // 638
SimpleSchema.prototype.addValidator = SimpleSchema.prototype.validator = function(func) {                              // 639
  this._validators.push(func);                                                                                         // 640
};                                                                                                                     // 641
                                                                                                                       // 642
/**                                                                                                                    // 643
 * @method SimpleSchema.prototype.pick                                                                                 // 644
 * @param {[fields]} The list of fields to pick to instantiate the subschema                                           // 645
 * @returns {SimpleSchema} The subschema                                                                               // 646
 */                                                                                                                    // 647
SimpleSchema.prototype.pick = function(/* arguments */) {                                                              // 648
  var self = this;                                                                                                     // 649
  var args = _.toArray(arguments);                                                                                     // 650
  args.unshift(self._schema);                                                                                          // 651
                                                                                                                       // 652
  var newSchema = _.pick.apply(null, args);                                                                            // 653
  return new SimpleSchema(newSchema);                                                                                  // 654
};                                                                                                                     // 655
                                                                                                                       // 656
/**                                                                                                                    // 657
 * @method SimpleSchema.prototype.clean                                                                                // 658
 * @param {Object} doc - Document or modifier to clean. Referenced object will be modified in place.                   // 659
 * @param {Object} [options]                                                                                           // 660
 * @param {Boolean} [options.filter=true] - Do filtering?                                                              // 661
 * @param {Boolean} [options.autoConvert=true] - Do automatic type converting?                                         // 662
 * @param {Boolean} [options.removeEmptyStrings=true] - Remove keys in normal object or $set where the value is an empty string?
 * @param {Boolean} [options.trimStrings=true] - Trim string values?                                                   // 664
 * @param {Boolean} [options.getAutoValues=true] - Inject automatic and default values?                                // 665
 * @param {Boolean} [options.isModifier=false] - Is doc a modifier object?                                             // 666
 * @param {Object} [options.extendAutoValueContext] - This object will be added to the `this` context of autoValue functions.
 * @returns {Object} The modified doc.                                                                                 // 668
 *                                                                                                                     // 669
 * Cleans a document or modifier object. By default, will filter, automatically                                        // 670
 * type convert where possible, and inject automatic/default values. Use the options                                   // 671
 * to skip one or more of these.                                                                                       // 672
 */                                                                                                                    // 673
SimpleSchema.prototype.clean = function(doc, options) {                                                                // 674
  var self = this;                                                                                                     // 675
                                                                                                                       // 676
  // By default, doc will be filtered and autoconverted                                                                // 677
  options = _.extend({                                                                                                 // 678
    filter: true,                                                                                                      // 679
    autoConvert: true,                                                                                                 // 680
    removeEmptyStrings: true,                                                                                          // 681
    trimStrings: true,                                                                                                 // 682
    getAutoValues: true,                                                                                               // 683
    isModifier: false,                                                                                                 // 684
    extendAutoValueContext: {}                                                                                         // 685
  }, options || {});                                                                                                   // 686
                                                                                                                       // 687
  // Convert $pushAll (deprecated) to $push with $each                                                                 // 688
  if ("$pushAll" in doc) {                                                                                             // 689
    console.warn("SimpleSchema.clean: $pushAll is deprecated; converting to $push with $each");                        // 690
    doc.$push = doc.$push || {};                                                                                       // 691
    for (var field in doc.$pushAll) {                                                                                  // 692
      doc.$push[field] = doc.$push[field] || {};                                                                       // 693
      doc.$push[field].$each = doc.$push[field].$each || [];                                                           // 694
      for (var i = 0, ln = doc.$pushAll[field].length; i < ln; i++) {                                                  // 695
        doc.$push[field].$each.push(doc.$pushAll[field][i]);                                                           // 696
      }                                                                                                                // 697
      delete doc.$pushAll;                                                                                             // 698
    }                                                                                                                  // 699
  }                                                                                                                    // 700
                                                                                                                       // 701
  var mDoc = new MongoObject(doc, self._blackboxKeys);                                                                 // 702
                                                                                                                       // 703
  // Clean loop                                                                                                        // 704
  if (options.filter || options.autoConvert || options.removeEmptyStrings || options.trimStrings) {                    // 705
    mDoc.forEachNode(function() {                                                                                      // 706
      var gKey = this.genericKey, p, def, val;                                                                         // 707
      if (gKey) {                                                                                                      // 708
        def = self._schema[gKey];                                                                                      // 709
        val = this.value;                                                                                              // 710
        // Filter out props if necessary; any property is OK for $unset because we want to                             // 711
        // allow conversions to remove props that have been removed from the schema.                                   // 712
        if (options.filter && this.operator !== "$unset" && !self.allowsKey(gKey)) {                                   // 713
          // XXX Special handling for $each; maybe this could be made nicer                                            // 714
          if (this.position.slice(-7) === "[$each]") {                                                                 // 715
            mDoc.removeValueForPosition(this.position.slice(0, -7));                                                   // 716
          } else {                                                                                                     // 717
            this.remove();                                                                                             // 718
          }                                                                                                            // 719
          if (SimpleSchema.debug) {                                                                                    // 720
            console.info('SimpleSchema.clean: filtered out value that would have affected key "' + gKey + '", which is not allowed by the schema');
          }                                                                                                            // 722
          return; // no reason to do more                                                                              // 723
        }                                                                                                              // 724
        if (val !== void 0) {                                                                                          // 725
          // Autoconvert values if requested and if possible                                                           // 726
          var wasAutoConverted = false;                                                                                // 727
          if (options.autoConvert && def) {                                                                            // 728
            var newVal = typeconvert(val, def.type);                                                                   // 729
            if (newVal !== void 0 && newVal !== val) {                                                                 // 730
              // remove empty strings                                                                                  // 731
              if (options.removeEmptyStrings && (!this.operator || this.operator === "$set") && typeof newVal === "string" && !newVal.length) {
                // For a document, we remove any fields that are being set to an empty string                          // 733
                newVal = void 0;                                                                                       // 734
                // For a modifier, we $unset any fields that are being set to an empty string                          // 735
                if (this.operator === "$set") {                                                                        // 736
                  p = this.position.replace("$set", "$unset");                                                         // 737
                  mDoc.setValueForPosition(p, "");                                                                     // 738
                }                                                                                                      // 739
              }                                                                                                        // 740
              // trim strings                                                                                          // 741
              else if (options.trimStrings && typeof newVal === "string") {                                            // 742
                newVal = S(newVal).trim().s;                                                                           // 743
              }                                                                                                        // 744
                                                                                                                       // 745
              // Change value; if undefined, will remove it                                                            // 746
              SimpleSchema.debug && console.info('SimpleSchema.clean: autoconverted value ' + val + ' from ' + typeof val + ' to ' + typeof newVal + ' for ' + gKey);
              this.updateValue(newVal);                                                                                // 748
              wasAutoConverted = true;                                                                                 // 749
            }                                                                                                          // 750
          }                                                                                                            // 751
          if (!wasAutoConverted) {                                                                                     // 752
            // remove empty strings                                                                                    // 753
            if (options.removeEmptyStrings && (!this.operator || this.operator === "$set") && typeof val === "string" && !val.length) {
              // For a document, we remove any fields that are being set to an empty string                            // 755
              this.remove();                                                                                           // 756
              // For a modifier, we $unset any fields that are being set to an empty string                            // 757
              if (this.operator === "$set") {                                                                          // 758
                p = this.position.replace("$set", "$unset");                                                           // 759
                mDoc.setValueForPosition(p, "");                                                                       // 760
              }                                                                                                        // 761
            }                                                                                                          // 762
            // trim strings                                                                                            // 763
            else if (options.trimStrings && typeof val === "string" && (!def || (def && def.trim !== false))) {        // 764
              this.updateValue(S(val).trim().s);                                                                       // 765
            }                                                                                                          // 766
          }                                                                                                            // 767
        }                                                                                                              // 768
      }                                                                                                                // 769
    }, {endPointsOnly: false});                                                                                        // 770
  }                                                                                                                    // 771
                                                                                                                       // 772
  // Set automatic values                                                                                              // 773
  options.getAutoValues && getAutoValues.call(self, mDoc, options.isModifier, options.extendAutoValueContext);         // 774
                                                                                                                       // 775
  return doc;                                                                                                          // 776
};                                                                                                                     // 777
                                                                                                                       // 778
// Returns the entire schema object or just the definition for one key                                                 // 779
// in the schema.                                                                                                      // 780
SimpleSchema.prototype.schema = function(key) {                                                                        // 781
  var self = this;                                                                                                     // 782
  // if not null or undefined (more specific)                                                                          // 783
  if (key !== null && key !== void 0) {                                                                                // 784
    return self._schema[SimpleSchema._makeGeneric(key)];                                                               // 785
  } else {                                                                                                             // 786
    return self._schema;                                                                                               // 787
  }                                                                                                                    // 788
};                                                                                                                     // 789
                                                                                                                       // 790
// Returns the evaluated definition for one key in the schema                                                          // 791
// key = non-generic key                                                                                               // 792
// [propList] = props to include in the result, for performance                                                        // 793
// [functionContext] = used for evaluating schema options that are functions                                           // 794
SimpleSchema.prototype.getDefinition = function(key, propList, functionContext) {                                      // 795
  var self = this;                                                                                                     // 796
  var defs = self.schema(key);                                                                                         // 797
  if (!defs) {                                                                                                         // 798
    return;                                                                                                            // 799
  }                                                                                                                    // 800
                                                                                                                       // 801
  if (_.isArray(propList)) {                                                                                           // 802
    defs = _.pick(defs, propList);                                                                                     // 803
  } else {                                                                                                             // 804
    defs = _.clone(defs);                                                                                              // 805
  }                                                                                                                    // 806
                                                                                                                       // 807
  // For any options that support specifying a function,                                                               // 808
  // evaluate the functions.                                                                                           // 809
  _.each(['min', 'max', 'minCount', 'maxCount', 'allowedValues', 'optional', 'label'], function (prop) {               // 810
    if (_.isFunction(defs[prop])) {                                                                                    // 811
      defs[prop] = defs[prop].call(functionContext || {});                                                             // 812
    }                                                                                                                  // 813
  });                                                                                                                  // 814
                                                                                                                       // 815
  // Inflect label if not defined                                                                                      // 816
  defs.label = defs.label || inflectedLabel(key);                                                                      // 817
                                                                                                                       // 818
  return defs;                                                                                                         // 819
};                                                                                                                     // 820
                                                                                                                       // 821
// Check if the key is a nested dot-syntax key inside of a blackbox object                                             // 822
SimpleSchema.prototype.keyIsInBlackBox = function(key) {                                                               // 823
  var self = this;                                                                                                     // 824
  var parentPath = SimpleSchema._makeGeneric(key), lastDot, def;                                                       // 825
                                                                                                                       // 826
  // Iterate the dot-syntax hierarchy until we find a key in our schema                                                // 827
  do {                                                                                                                 // 828
    lastDot = parentPath.lastIndexOf('.');                                                                             // 829
    if (lastDot !== -1) {                                                                                              // 830
      parentPath = parentPath.slice(0, lastDot); // Remove last path component                                         // 831
      def = self.getDefinition(parentPath);                                                                            // 832
    }                                                                                                                  // 833
  } while (lastDot !== -1 && !def);                                                                                    // 834
                                                                                                                       // 835
  return !!(def && def.blackbox);                                                                                      // 836
};                                                                                                                     // 837
                                                                                                                       // 838
// Use to dynamically change the schema labels.                                                                        // 839
SimpleSchema.prototype.labels = function(labels) {                                                                     // 840
  var self = this;                                                                                                     // 841
  _.each(labels, function(label, fieldName) {                                                                          // 842
    if (!_.isString(label) && !_.isFunction(label)) {                                                                  // 843
      return;                                                                                                          // 844
    }                                                                                                                  // 845
                                                                                                                       // 846
    if (!(fieldName in self._schema)) {                                                                                // 847
      return;                                                                                                          // 848
    }                                                                                                                  // 849
                                                                                                                       // 850
    self._schema[fieldName].label = label;                                                                             // 851
    self._depsLabels[fieldName] && self._depsLabels[fieldName].changed();                                              // 852
  });                                                                                                                  // 853
};                                                                                                                     // 854
                                                                                                                       // 855
// should be used to safely get a label as string                                                                      // 856
SimpleSchema.prototype.label = function(key) {                                                                         // 857
  var self = this;                                                                                                     // 858
                                                                                                                       // 859
  // Get all labels                                                                                                    // 860
  if (key === null || key === void 0) {                                                                                // 861
    var result = {};                                                                                                   // 862
    _.each(self.schema(), function(def, fieldName) {                                                                   // 863
      result[fieldName] = self.label(fieldName);                                                                       // 864
    });                                                                                                                // 865
    return result;                                                                                                     // 866
  }                                                                                                                    // 867
                                                                                                                       // 868
  // Get label for one field                                                                                           // 869
  var def = self.getDefinition(key);                                                                                   // 870
  if (def) {                                                                                                           // 871
    var genericKey = SimpleSchema._makeGeneric(key);                                                                   // 872
    self._depsLabels[genericKey] && self._depsLabels[genericKey].depend();                                             // 873
    return def.label;                                                                                                  // 874
  }                                                                                                                    // 875
                                                                                                                       // 876
  return null;                                                                                                         // 877
};                                                                                                                     // 878
...
// Global messages                                                                                                     // 880
                                                                                                                       // 881
SimpleSchema._globalMessages = {                                                                                       // 882
  required: "[label] is required",                                                                                     // 883
  minString: "[label] must be at least [min] characters",                                                              // 884
  maxString: "[label] cannot exceed [max] characters",                                                                 // 885
  minNumber: "[label] must be at least [min]",                                                                         // 886
  maxNumber: "[label] cannot exceed [max]",                                                                            // 887
  minNumberExclusive: "[label] must be greater than [min]",                                                            // 888
  maxNumberExclusive: "[label] must be less than [max]",                                                               // 889
  minDate: "[label] must be on or after [min]",                                                                        // 890
  maxDate: "[label] cannot be after [max]",                                                                            // 891
  minCount: "You must specify at least [minCount] values",                                                             // 892
  maxCount: "You cannot specify more than [maxCount] values",                                                          // 893
  noDecimal: "[label] must be an integer",                                                                             // 894
  notAllowed: "[value] is not an allowed value",                                                                       // 895
  expectedString: "[label] must be a string",                                                                          // 896
  expectedNumber: "[label] must be a number",                                                                          // 897
  expectedBoolean: "[label] must be a boolean",                                                                        // 898
  expectedArray: "[label] must be an array",                                                                           // 899
  expectedObject: "[label] must be an object",                                                                         // 900
  expectedConstructor: "[label] must be a [type]",                                                                     // 901
  regEx: [                                                                                                             // 902
    {msg: "[label] failed regular expression validation"},                                                             // 903
    {exp: SimpleSchema.RegEx.Email, msg: "[label] must be a valid e-mail address"},                                    // 904
    {exp: SimpleSchema.RegEx.WeakEmail, msg: "[label] must be a valid e-mail address"},                                // 905
    {exp: SimpleSchema.RegEx.Domain, msg: "[label] must be a valid domain"},                                           // 906
    {exp: SimpleSchema.RegEx.WeakDomain, msg: "[label] must be a valid domain"},                                       // 907
    {exp: SimpleSchema.RegEx.IP, msg: "[label] must be a valid IPv4 or IPv6 address"},                                 // 908
    {exp: SimpleSchema.RegEx.IPv4, msg: "[label] must be a valid IPv4 address"},                                       // 909
    {exp: SimpleSchema.RegEx.IPv6, msg: "[label] must be a valid IPv6 address"},                                       // 910
    {exp: SimpleSchema.RegEx.Url, msg: "[label] must be a valid URL"},                                                 // 911
    {exp: SimpleSchema.RegEx.Id, msg: "[label] must be a valid alphanumeric ID"}                                       // 912
  ],                                                                                                                   // 913
  keyNotInSchema: "[label] is not allowed by the schema"                                                               // 914
};                                                                                                                     // 915
                                                                                                                       // 916
SimpleSchema.messages = function(messages) {                                                                           // 917
  _.extend(SimpleSchema._globalMessages, messages);                                                                    // 918
  SimpleSchema._depsGlobalMessages.changed();                                                                          // 919
};                                                                                                                     // 920
                                                                                                                       // 921
// Schema-specific messages                                                                                            // 922
                                                                                                                       // 923
SimpleSchema.prototype.messages = function(messages) {                                                                 // 924
  var self = this;                                                                                                     // 925
  _.extend(self._messages, messages);                                                                                  // 926
  self._depsMessages.changed();                                                                                        // 927
};                                                                                                                     // 928
                                                                                                                       // 929
// Returns a string message for the given error type and key. Uses the                                                 // 930
// def and value arguments to fill in placeholders in the error messages.                                              // 931
SimpleSchema.prototype.messageForError = function(type, key, def, value) {                                             // 932
  var self = this;                                                                                                     // 933
                                                                                                                       // 934
  // We proceed even if we can't get a definition because it might be a keyNotInSchema error                           // 935
  def = def || self.getDefinition(key, ['regEx', 'label', 'minCount', 'maxCount', 'min', 'max', 'type']) || {};        // 936
                                                                                                                       // 937
  // Adjust for complex types, currently only regEx,                                                                   // 938
  // where we might have regEx.1 meaning the second                                                                    // 939
  // expression in the array.                                                                                          // 940
  var firstTypePeriod = type.indexOf("."), index = null;                                                               // 941
  if (firstTypePeriod !== -1) {                                                                                        // 942
    index = type.substring(firstTypePeriod + 1);                                                                       // 943
    index = parseInt(index, 10);                                                                                       // 944
    type = type.substring(0, firstTypePeriod);                                                                         // 945
  }                                                                                                                    // 946
                                                                                                                       // 947
  // Which regExp is it?                                                                                               // 948
  var regExpMatch;                                                                                                     // 949
  if (type === "regEx") {                                                                                              // 950
    if (index !== null && index !== void 0 && !isNaN(index)) {                                                         // 951
      regExpMatch = def.regEx[index];                                                                                  // 952
    } else {                                                                                                           // 953
      regExpMatch = def.regEx;                                                                                         // 954
    }                                                                                                                  // 955
    if (regExpMatch) {                                                                                                 // 956
      regExpMatch = regExpMatch.toString();                                                                            // 957
    }                                                                                                                  // 958
  }                                                                                                                    // 959
                                                                                                                       // 960
  // Prep some strings to be used when finding the correct message for this error                                      // 961
  var typePlusKey = type + " " + key;                                                                                  // 962
  var genericKey = SimpleSchema._makeGeneric(key);                                                                     // 963
  var typePlusGenKey = type + " " + genericKey;                                                                        // 964
                                                                                                                       // 965
  // reactively update when message templates or labels are changed                                                    // 966
  SimpleSchema._depsGlobalMessages.depend();                                                                           // 967
  self._depsMessages.depend();                                                                                         // 968
  self._depsLabels[key] && self._depsLabels[key].depend();                                                             // 969
                                                                                                                       // 970
  // Prep a function that finds the correct message for regEx errors                                                   // 971
  function findRegExError(message) {                                                                                   // 972
    if (type !== "regEx" || !_.isArray(message)) {                                                                     // 973
      return message;                                                                                                  // 974
    }                                                                                                                  // 975
    // Parse regEx messages, which are provided in a special object array format                                       // 976
    // [{exp: RegExp, msg: "Foo"}]                                                                                     // 977
    // Where `exp` is optional                                                                                         // 978
                                                                                                                       // 979
    var msgObj;                                                                                                        // 980
    // First see if there's one where exp matches this expression                                                      // 981
    if (regExpMatch) {                                                                                                 // 982
      msgObj = _.find(message, function (o) {                                                                          // 983
        return o.exp && o.exp.toString() === regExpMatch;                                                              // 984
      });                                                                                                              // 985
    }                                                                                                                  // 986
                                                                                                                       // 987
    // If not, see if there's a default message defined                                                                // 988
    if (!msgObj) {                                                                                                     // 989
      msgObj = _.findWhere(message, {exp: null});                                                                      // 990
      if (!msgObj) {                                                                                                   // 991
        msgObj = _.findWhere(message, {exp: void 0});                                                                  // 992
      }                                                                                                                // 993
    }                                                                                                                  // 994
                                                                                                                       // 995
    return msgObj ? msgObj.msg : null;                                                                                 // 996
  }                                                                                                                    // 997
                                                                                                                       // 998
  // Try finding the correct message to use at various levels, from most                                               // 999
  // specific to least specific.                                                                                       // 1000
  var message = self._messages[typePlusKey] ||                  // (1) Use schema-specific message for specific key    // 1001
                self._messages[typePlusGenKey] ||               // (2) Use schema-specific message for generic key     // 1002
                self._messages[type];                           // (3) Use schema-specific message for type            // 1003
  message = findRegExError(message);                                                                                   // 1004
                                                                                                                       // 1005
  if (!message) {                                                                                                      // 1006
    message = SimpleSchema._globalMessages[typePlusKey] ||      // (4) Use global message for specific key             // 1007
              SimpleSchema._globalMessages[typePlusGenKey] ||   // (5) Use global message for generic key              // 1008
              SimpleSchema._globalMessages[type];               // (6) Use global message for type                     // 1009
    message = findRegExError(message);                                                                                 // 1010
  }                                                                                                                    // 1011
                                                                                                                       // 1012
  if (!message) {                                                                                                      // 1013
    return "Unknown validation error";                                                                                 // 1014
  }                                                                                                                    // 1015
                                                                                                                       // 1016
  // Now replace all placeholders in the message with the correct values                                               // 1017
                                                                                                                       // 1018
  // [label]                                                                                                           // 1019
  self._depsLabels[key] && self._depsLabels[key].depend(); // React to label changes                                   // 1020
  message = message.replace("[label]", def.label);                                                                     // 1021
                                                                                                                       // 1022
  // [minCount]                                                                                                        // 1023
  if (typeof def.minCount !== "undefined") {                                                                           // 1024
    message = message.replace("[minCount]", def.minCount);                                                             // 1025
  }                                                                                                                    // 1026
                                                                                                                       // 1027
  // [maxCount]                                                                                                        // 1028
  if (typeof def.maxCount !== "undefined") {                                                                           // 1029
    message = message.replace("[maxCount]", def.maxCount);                                                             // 1030
  }                                                                                                                    // 1031
                                                                                                                       // 1032
  // [value]                                                                                                           // 1033
  if (value !== void 0 && value !== null) {                                                                            // 1034
    message = message.replace("[value]", value.toString());                                                            // 1035
  } else {                                                                                                             // 1036
    message = message.replace("[value]", 'null');                                                                      // 1037
  }                                                                                                                    // 1038
                                                                                                                       // 1039
  // [min] and [max]                                                                                                   // 1040
  var min = def.min;                                                                                                   // 1041
  var max = def.max;                                                                                                   // 1042
  if (def.type === Date || def.type === [Date]) {                                                                      // 1043
    if (typeof min !== "undefined") {                                                                                  // 1044
      message = message.replace("[min]", Utility.dateToDateString(min));                                               // 1045
    }                                                                                                                  // 1046
    if (typeof max !== "undefined") {                                                                                  // 1047
      message = message.replace("[max]", Utility.dateToDateString(max));                                               // 1048
    }                                                                                                                  // 1049
  } else {                                                                                                             // 1050
    if (typeof min !== "undefined") {                                                                                  // 1051
      message = message.replace("[min]", min);                                                                         // 1052
    }                                                                                                                  // 1053
    if (typeof max !== "undefined") {                                                                                  // 1054
      message = message.replace("[max]", max);                                                                         // 1055
    }                                                                                                                  // 1056
  }                                                                                                                    // 1057
                                                                                                                       // 1058
  // [type]                                                                                                            // 1059
  if (def.type instanceof Function) {                                                                                  // 1060
    message = message.replace("[type]", def.type.name);                                                                // 1061
  }                                                                                                                    // 1062
                                                                                                                       // 1063
  // Now return the message                                                                                            // 1064
  return message;                                                                                                      // 1065
};                                                                                                                     // 1066
                                                                                                                       // 1067
// Returns true if key is explicitly allowed by the schema or implied                                                  // 1068
// by other explicitly allowed keys.                                                                                   // 1069
// The key string should have $ in place of any numeric array positions.                                               // 1070
SimpleSchema.prototype.allowsKey = function(key) {                                                                     // 1071
  var self = this;                                                                                                     // 1072
                                                                                                                       // 1073
  // Loop through all keys in the schema                                                                               // 1074
  return _.any(self._schemaKeys, function(schemaKey) {                                                                 // 1075
                                                                                                                       // 1076
    // If the schema key is the test key, it's allowed.                                                                // 1077
    if (schemaKey === key) {                                                                                           // 1078
      return true;                                                                                                     // 1079
    }                                                                                                                  // 1080
                                                                                                                       // 1081
    // Black box handling                                                                                              // 1082
    if (self.schema(schemaKey).blackbox === true) {                                                                    // 1083
      var kl = schemaKey.length;                                                                                       // 1084
      var compare1 = key.slice(0, kl + 2);                                                                             // 1085
      var compare2 = compare1.slice(0, -1);                                                                            // 1086
                                                                                                                       // 1087
      // If the test key is the black box key + ".$", then the test                                                    // 1088
      // key is NOT allowed because black box keys are by definition                                                   // 1089
      // only for objects, and not for arrays.                                                                         // 1090
      if (compare1 === schemaKey + '.$') {                                                                             // 1091
        return false;                                                                                                  // 1092
      }                                                                                                                // 1093
                                                                                                                       // 1094
      // Otherwise                                                                                                     // 1095
      if (compare2 === schemaKey + '.') {                                                                              // 1096
        return true;                                                                                                   // 1097
      }                                                                                                                // 1098
    }                                                                                                                  // 1099
                                                                                                                       // 1100
    return false;                                                                                                      // 1101
                                                                                                                       ...
                                                                                                                       // 1104
SimpleSchema.prototype.newContext = function() {                                                                       // 1105
  return new SimpleSchemaValidationContext(this);                                                                      // 1106
};                                                                                                                     // 1107
                                                                                                                       // 1108
// Returns all the child keys for the object identified by the generic prefix,                                         // 1109
// or all the top level keys if no prefix is supplied.                                                                 // 1110
SimpleSchema.prototype.objectKeys = function(keyPrefix) {                                                              // 1111
  var self = this;                                                                                                     // 1112
  if (!keyPrefix) {                                                                                                    // 1113
    return self._firstLevelSchemaKeys;                                                                                 // 1114
  }                                                                                                                    // 1115
  return self._objectKeys[keyPrefix + "."] || [];                                                                      // 1116
};                                                                                                                     // 1117
                                                                                                                       // 1118
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
