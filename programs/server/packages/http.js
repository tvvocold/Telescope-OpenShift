...
var _call = function(method, url, options, callback) {                                                              // 7
  ...
  var req_options = {                                                                                               // 71
    ...
    headers: headers                                                                                                // 79
                                                                                                                    ...
                                                                                                                    // 81
  request(req_options, function(error, res, body) {                                                                 // 82
    var response = null;                                                                                            // 83
                                                                                                                    // 84
    if (! error) {                                                                                                  // 85
                                                                                                                    // 86
      response = {};                                                                                                // 87
      response.statusCode = res.statusCode;                                                                         // 88
      response.content = body;                                                                                      // 89
      response.headers = res.headers;                                                                               // 90
                                                                                                                    // 91
      populateData(response);                                                                                       // 92
                                                                                                                    // 93
      if (response.statusCode >= 400)                                                                               // 94
        error = makeErrorByStatus(response.statusCode, response.content);                                           // 95
    }                                                                                                               // 96
                                                                                                                    // 97
    callback(error, response);                                                                                      // 98
                                                                                                                    // 99
  });                                                                                                               // 100
};                                                                                                                  // 101
                                                                                                                    // 102
HTTP.call = Meteor.wrapAsync(_call);                                                                                // 103
                                                                                                                    // 104
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
